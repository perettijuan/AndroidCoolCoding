 ...
 * Remove -> Move -> Add. **/
public abstract class PendingItemAnimator<H extends RecyclerView.ViewHolder> extends RecyclerView.ItemAnimator {
    ...
    protected ViewPropertyAnimatorCompat animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        final View view = holder.itemView;
