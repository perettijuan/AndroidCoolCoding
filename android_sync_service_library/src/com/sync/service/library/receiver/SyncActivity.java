...
/**
 * An abstract {@link FragmentActivity} that defines common behavior for all
 * activities that will execute some sync action with the back-end via
 * {@link SyncService}.
 * 
...
public abstract class SyncActivity extends FragmentActivity implements AsyncReceiver {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.getParcelable(KEY_RECEIVER) != null) {
            try {
                mReceiver = (DetachableResultReceiver) savedInstanceState.getParcelable(KEY_RECEIVER);
            } catch (Exception e) {
     ...
     * of this class wishes to publish it's own progress, needs to override
     * this method
     * 
     * @param request
